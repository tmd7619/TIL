...
numStr = "720"
numNum = 100
print(numStr + numNum) # >>> TypeError #같은 Value끼리만 연산이 가능
...
# 문자열을 쪼개는 함수 : split() 문자열을 () 기준으로 쪼개고 ,리스트형식으로 변환
...
print(a.count('k'))
print(a[2] + ' ~ ' + a[4])
print(a.count('k',2,5)) # 인덱스 2 ~ 인덱스 4까지 중 k가 있냐?

brandname = 'cocacola'
print(brandname.count())
